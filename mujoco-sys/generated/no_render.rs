...
pub const mjVERSION_HEADER: u32 = 231;
...
fn bindgen_test_layout_mjModel_() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).body_gravcomp) as usize - ptr as usize },
        1296usize,
        concat!(
            "Offset of field: ",
            stringify!(mjModel_),
            "::",
            stringify!(body_gravcomp)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).actuator_actadr) as usize - ptr as usize },
        2776usize,
        concat!(
            "Offset of field: ",
            stringify!(mjModel_),
            "::",
            stringify!(actuator_actadr)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).actuator_actnum) as usize - ptr as usize },
        2784usize,
        concat!(
            "Offset of field: ",
            stringify!(mjModel_),
            "::",
            stringify!(actuator_actnum)
        )
    );
    assert_eq!(
...
fn bindgen_test_layout_mjpPlugin_() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).visualize) as usize - ptr as usize },
        96usize,
        concat!(
            "Offset of field: ",
            stringify!(mjpPlugin_),
